...
import com.igirerwanda.application_portal_backend.application.repository.PersonalInfoRepository;
...
public class UserApplicationServiceTest {
    ...
    // Note: Mock other repositories (EducationalRepository, etc.) if testing those methods specifically
    ...
    @Test
    void savePersonalInfo_OwnershipCheck() {
