...
import com.igirerwanda.application_portal_backend.application.service.SystemRejectionService;
...
public class SystemRejectionJob {
    ...
    public void evaluatePendingApplications() {
        ...
        List<Application> pendingApplications = applicationRepository.findByStatusAndDeletedFalse(ApplicationStatus.PENDING_REVIEW);
